...
```js copy showLineNumbers filename="penjumlahan.js"
function tambah(a, b) {
  return a + b;
}
...
```json copy showLineNumbers filename="package.json" {11-12}
{
  "name": "project-name",
  "private": true,
  "version": "0.0.0",
...
```jsx copy showLineNumbers filename="src/__tests__/test-utils.jsx"
...
```jsx copy showLineNumbers filename="src/__tests__/components/navbar.test.jsx"
